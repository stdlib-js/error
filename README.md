...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/error@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { error2json, reviveError } from 'https://cdn.jsdelivr.net/gh/stdlib-js/error@v0.1.1-esm/index.mjs';
```
