...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/error@v0.4.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/error/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/error/actions/workflows/test.yml?query=branch:v0.4.1
